...
int validar_horizontal(int linha, int coluna)
{
    ...
    if (coluna < 0 || coluna + TAMANHO_NAVIO - 1 >= TAMANHO_TABULEIRO) return 0;
    return 1;
}
...
int validar_vertical(int linha, int coluna)
{
    ...
    if (linha < 0 || linha + TAMANHO_NAVIO - 1 >= TAMANHO_TABULEIRO) return 0;
    return 1;
}
                            ...
                            int linha, int coluna, int horizontal)
{
    ...
    for (k = 0; k < TAMANHO_NAVIO; k++) {
        if (horizontal) {
            if (tabuleiro[linha][coluna + k] == NAVIO) return 1;
        } else {
            if (tabuleiro[linha + k][coluna] == NAVIO) return 1;
        }
    }
    return 0;
}
...
int validar_diagonal_asc(int linha, int coluna)
{
    if (linha - (TAMANHO_NAVIO - 1) < 0 || linha >= TAMANHO_TABULEIRO) return 0;
    if (coluna < 0 || coluna + TAMANHO_NAVIO - 1 >= TAMANHO_TABULEIRO) return 0;
    return 1;
}
                                          ...
                                          int linha, int coluna)
{
    int k;
    for (k = 0; k < TAMANHO_NAVIO; k++)
        if (tabuleiro[linha + k][coluna + k] == NAVIO) return 1;
    return 0;
}
